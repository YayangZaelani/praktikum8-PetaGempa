...
<body>
    ...
    <h2>Kepadatan Penduduk Daerah Istimewa Yogyakarta</h2>
    ...
    <script>
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Kepadatan Penduduk Di Provinsi DI Yogyakarta</h4>' +  (props ?
                '<b>' + props.name + '</b><br />' + props.kepadatan.toLocaleString('id-ID') + ' jiwa/km²'
                : 'Hover over a kepadatan');
        };
        ...
        legend.onAdd = function (map) {
            ...
            var div = L.DomUtil.create('div', 'info legend'),
                grades = [0, 500, 1000, 1500, 2000, 3000, 10000, 20000],
                labels = [];
