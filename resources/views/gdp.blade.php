...
<body>
    ...
    <h2>Sebaran Gross Domestic Product Kota-Kota Daerah Istimewa Yogyakarta</h2>
    ...
    <script>
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Sebaran Gross Domestic Product Kota-Kota DI Provinsi DI Yogyakarta</h4>' +  (props ?
                '<b>' + props.name + '</b><br />' + ' Total perkapita :' + props.gdp.toLocaleString('id-ID')
